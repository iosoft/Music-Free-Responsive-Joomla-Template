...
<div class="kblock kcategories-<?php echo intval($section->id) ?>">
	...
	<div class="kcontainer" id="catid_<?php echo intval($section->id) ?>">
      ...
      <div class="kblocktable<?php echo $htmlClassBlockTable ?>" id="kcat<?php echo intval($section->id) ?>">
      	...
      	?>
		<div class="k<?php echo $tabclass [$k ^= 1], isset ( $category->class_sfx ) ? ' k' . $this->escape($tabclass [$k]) . $this->escape($category->class_sfx) : '' ?> <?php if ($category->getNewCount()) echo 'knew'; ?>" id="kcat<?php echo intval($category->id) ?>">
        		...
        		<?php endif; ?>
      			...
      			<div class="kcol-mid kcol-kcattopics visible-desktop">
      			...
      			<div class="kcol-mid kcol-kcatreplies visible-desktop">
