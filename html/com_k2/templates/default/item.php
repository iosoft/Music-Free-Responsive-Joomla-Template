		...
		<header>
			...
			<?php if($params->get('itemTitle')): ?>
				...
				<ul>
						...
						<li>
								<time datetime="<?php echo JHTML::_('date', $this->item->created, JText::_('d M Y h:i')); ?>"> <?php echo JHTML::_('date', $this->item->created, JText::_('d F, Y')); ?></span> </time>
						</li>
						<?php endif; ?>
						...
						<li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
								...
								<div>
										...
										<div><span> <?php echo JText::_('K2_POSTED_BY'); ?>
												...
												<?php endif; ?>
												</span> <span> <?php echo JHTML::_('date', $comment->commentDate, JText::_('DATE_FORMAT_LC2')); ?> </span> <span> <a class="commentLink" href="<?php echo $this->item->link; ?>#comment<?php echo $comment->id; ?>" name="comment<?php echo $comment->id; ?>" id="comment<?php echo $comment->id; ?>"> <?php echo JText::_('K2_COMMENT_LINK'); ?> </a> </span></div>
								</div>
						</li>
						<?php endforeach; ?>
				</ul>
